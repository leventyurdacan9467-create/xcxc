...
export function BagScreen({
  ...
  // 1. Ana ekrandakinin birebir aynısı gün hesaplaması
  let tripDays = 1;
  try {
  ...
  // 2. Ana ekranla birebir aynı akıllı motoru çağırıyoruz (Böylece ID'ler ve ürünler %100 uyuşur)
  ...
  // Gruplardaki tüm ürünleri tek bir listeye alıp hangi gruba ait olduklarını ekliyoruz
